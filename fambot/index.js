...
FamBot.prototype.loadKeywords = function ()
{
    var result = [];
...
FamBot.prototype.checkMessageForKeywords = function(message, triggers, callback)
{
...
FamBot.prototype.getKeyByValue = function(object, value)
{
...
FamBot.prototype.runKeywordFunction = function(keywordFunction, keyword, message, callback)
{
    this[keywordFunction].Message(keyword, message, callback);
}

module.exports = FamBot;